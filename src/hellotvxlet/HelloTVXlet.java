    ...
    private void showMenu(){
        ...
        if(niveau == null){
            ...
            if(niveau.equals("simpel")){
              ...
              HTextButton back = new HTextButton("<<",(((width-(10*smallButtonSize))/2)+(smallButtonSize*0))-20,topDown+70,50,smallButtonSize);
              ...
              knop1.setBackgroundMode(HVisible.BACKGROUND_FILL);
              knop1.setBackground(new DVBColor(194,55,0,255));
              knop1.setActionCommand(level+" 0");
              knop1.addHActionListener(this);
              scene.add(knop1);
              ...
              knop2.setBackgroundMode(HVisible.BACKGROUND_FILL);
              knop2.setBackground(new DVBColor(194,55,0,255));
              knop2.setActionCommand(level+" 1");
              knop2.addHActionListener(this);
              scene.add(knop2);
              ...
              knop3.setBackgroundMode(HVisible.BACKGROUND_FILL);
              knop3.setBackground(new DVBColor(194,55,0,255));
              knop3.setActionCommand(level+" 2");
              knop3.addHActionListener(this);
              scene.add(knop3);
              ...
              knop4.setBackgroundMode(HVisible.BACKGROUND_FILL);
              knop4.setBackground(new DVBColor(194,55,0,255));
              knop4.setActionCommand(level+" 3");
              knop4.addHActionListener(this);
              scene.add(knop4);
              ...
              knop5.setActionCommand(level+" 4");
              ...
              knop6.setActionCommand(level+" 5");
              ...
              knop7.setActionCommand(level+" 6");
              ...
              knop8.setActionCommand(level+" 7");
              ...
              knop9.setActionCommand(level+" 8");
              ...
              knop10.setActionCommand(level+" 9");
